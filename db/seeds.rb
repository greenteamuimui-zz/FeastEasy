...
p24 = Picture.create!(kitchen_id: k10.id, image_url: "http://res.cloudinary.com/greenteamuimui/image/upload/v1501051641/k10-p1_gdmbhc.jpg")
p25 = Picture.create!(kitchen_id: k10.id, image_url: "http://res.cloudinary.com/greenteamuimui/image/upload/v1501051642/k10-p2_ygivni.jpg")
p26 = Picture.create!(kitchen_id: k10.id, image_url: "http://res.cloudinary.com/greenteamuimui/image/upload/v1501051640/k10-p3_wrpcrl.jpg")
p27 = Picture.create!(kitchen_id: k11.id, image_url: "http://res.cloudinary.com/greenteamuimui/image/upload/v1501051643/k11-p2_aiiykj.jpg")
p28 = Picture.create!(kitchen_id: k11.id, image_url: "http://res.cloudinary.com/greenteamuimui/image/upload/v1501051642/k11-p1_negtj2.jpg")
p29 = Picture.create!(kitchen_id: k11.id, image_url: "http://res.cloudinary.com/greenteamuimui/image/upload/v1501051643/k11-p3_vgkftm.jpg")
p30 = Picture.create!(kitchen_id: k12.id, image_url: "http://res.cloudinary.com/greenteamuimui/image/upload/v1500877332/k6-p3_mt0u78.jpg")
p31 = Picture.create!(kitchen_id: k12.id, image_url: "http://res.cloudinary.com/greenteamuimui/image/upload/v1500570484/k1-p2_y1nysx.jpg")
p32 = Picture.create!(kitchen_id: k12.id, image_url: "http://res.cloudinary.com/greenteamuimui/image/upload/v1500571066/k3-p2_iif2df.jpg")
