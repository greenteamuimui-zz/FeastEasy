...
k7 = Kitchen.create!(user_id:u6.id, city_id:1, name:"Hans and Friends - German cuisine and humor", cuisine:"German", size:6, feast_time:"6:30 PM", address:"645 5th Street, San Francisco, CA 94107", phone:"760-282-2132", about:"Guten Morgen or Guten Abend, friends! I would like to invite you to my home to share a meal and conversation about German culture and about anything else that may pop up. Although, I’m pretty new to cooking, I’m certainly not new to appreciating German food. Be it hardy potatoes with meat sauces, sweet Apfelstrudel, or salty pretzels, I’m sure you will find something you like. And of course, no meal will be served without some German beer. You may want to take public transportation because I will not let you go home sober ;)")

k8 = Kitchen.create!(user_id:u7.id, city_id:1, name:"Vegan Paradise", cuisine:"Vegan", size:6, feast_time:"7:30 PM", address:"2320 Green Street, San Francisco, CA 94123", phone:"650-112-3255", about:"I’ve been there. Being vegan is not easy. Restaurants offer your basic quinoa salad and a few veggies. I believe that being vegan doesn’t mean you should compromise on quality. My meals are served made with delicious sauces and yummy bread. Let me surprise you by meals made of nuts, tofu, root vegetables, local fruits - I promise you, that even hard code meat eaters will leave thinking that they should consider that \"vegan thing\"")


k9 = Kitchen.create!(user_id:u8.id, city_id:1, name:"Homemade sushi party", cuisine:"Japanese", size:8, feast_time:"7:00 PM", address:"1800 Mission Street, San Francisco, CA 94103", phone:"651-322-1231", about:"I got hooked on the art of Sushi while living in Japan. I fell in love with the rice, fresh fish, delicate way of handling the knife, precise placement of sheets of seaweed. I have 3 rice cookers that I like to experiment with and I try different ingredients every time so feel free to come multiple times - it is very likely you will have different experiences every single time. I invite my guests to come early to help me cook. I truly believe that cooking sushi is a great way to learn new skills that you can use every day. Join me. You host, Johny.")
